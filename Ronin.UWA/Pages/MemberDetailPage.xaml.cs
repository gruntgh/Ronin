...
namespace Ronin.UWA.Pages
{
    ...
    public sealed partial class MemberDetailPage : Page
    {
        private static DependencyProperty s_itemProperty
            = DependencyProperty.Register("Item", typeof(Member), typeof(MemberDetailPage), new PropertyMetadata(null));
        ...
        public Member Item
        {
            get { return (Member)GetValue(s_itemProperty); }
